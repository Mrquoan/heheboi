...
__bundle_register("MVQUtils", function(require, _LOADED, __bundle_register, __bundle_modules)
    ...
    function MVQFind(className, methodName)
        ...
        if not classes or #classes == 0 then
            print("MVQFind: Không tìm thấy class " .. className)
            return false
        end
        local klass = classes[1]
        local method = klass:GetMethod(methodName)
        if not method or not method.methodPointer then
            print("MVQFind: Không tìm thấy method " .. methodName .. " trong " .. className)
            return false
        end
    ...
    _G.MVQFind = MVQFind
    _G.ClassFind = ClassFind
    _G.MethodFind = MethodFind
    Il2Cpp.MVQFind = MVQFind
    Il2Cpp.ClassFind = ClassFind
    Il2Cpp.MethodFind = MethodFind

    print("[MVQUtils] Loaded successfully")
end)

__bundle_require("MVQUtils")
